...
@section('title','Ecommerce Kateqoriyalar')
@section('content')
...
<h1 style="text-align:center;margin-bottom:20px;color:red;font-weight:bold;">
...
@endforeach
@else
<h1 style="text-align:center;font-weight:bold;font-size:50px;color:red;">Axtarılan kateqoriya üzrə nəticə tapılmadı</h1>
@endif
</div>
</div>
</div>
